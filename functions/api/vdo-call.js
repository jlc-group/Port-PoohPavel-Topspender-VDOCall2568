// Cloudflare Function for VDO Call API
...
export async function onRequest(context) {
  ...
  try {
    // Route handling
    if (url.pathname === '/api/vdo-call/customers' && request.method === 'GET') {
      const customers = await getVDOCallData();
    ...
    if (url.pathname.includes('/api/vdo-call/search/') && request.method === 'GET') {
    ...
    console.error('VDO Call API Error:', error);
    return new Response(JSON.stringify({
      success: false,
